...
const PinterestIcon = ({ size = 24, color = "currentColor", className = "" }) => (
  <svg 
    width={size} 
    height={size} 
    viewBox="0 0 24 24" 
    ...
    >
      ...
      <div className="contact-footer">
        <div className="social-links">
          <a href="https://github.com/Sonderssss" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
            <Github size={24} />
          </a>
          <a href="https://pin.it/179bbNvWn" target="_blank" rel="noopener noreferrer" aria-label="Pinterest">
